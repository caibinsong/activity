...
(function ($) {
        ...
        createClass(Table, [{
            ...
            value: function getTools() {
                ...
                for (var i = 0; i < tools.length; i++) {
                    ...
                    var $btn = $('<a class="t-button  ' + tool.toolIcon + '" title="' + tool.title + '" href="javascript:void(0)>'+ iStr + '<label class="t-btn-text">' + tool.text + '</label></a>');
                    $tools.append($btn);
                }
                var $btn = null;
                if (filterByColumn) {
    ...
    var header = {
        ...
        control: function (obj, wrap, _this, context) {
            ...
            downArrow = elements.isDownArrow ? '<i class=""></i>' : '';
            ...
            var tmpObj = $.extend(true, {}, DEFAULT, obj),
                ...
                aStr = '<a href="javascript:void(0)" class="t-button t-btn-search"><i class="t-btn-icon"></i><label class="t-btn-text">' + headerQuery.text + '</label></a>';
